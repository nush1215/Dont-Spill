...
function Hitbox:Destroy()
	...
	if self.HitboxObject then
		self.HitboxObject:SetAttribute(self.Tag, nil)
	end
...
function Hitbox:_Init()
	...
	local function onTagRemoved()
		if self.HitboxObject:GetAttribute(self.Tag) == nil then
	...
	tagConnection = self.HitboxObject:GetAttributeChangedSignal(self.Tag):Connect(onTagRemoved)
end
